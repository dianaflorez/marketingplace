...
class UsuarioSearch extends Usuario
{
    ...
    {
        return [
            [['idusu', 'idtide', 'role', 'activate', 'idemp', 'usumod'], 'integer'],
            [['nombre1', 'nombre2', 'apellido1', 'apellido2', 'identificacion', 'username', 'email', 'clave', 'authkey', 'accesstoken', 'estado', 'feccre', 'fecmod'], 'safe'],
        ];
    }
